...
cc.push("<li>");
cc.push("<div id=\""+item.domId+"\" class=\"tree-node tree-click_"+item.id+"\" id=\""+item.id+"\">");
for(var j=0;j<_1c6;j++){
cc.push("<span class=\"tree-indent\"></span>");
}
var _1c8=false;
if(item.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed tree-collapsed_"+item.id+"\"></span>");
...
cc.push("<span class=\"tree-title\" id='"+item.id+"'>"+opts.formatter.call(_1c3,item)+"</span>");
cc.push("</div>");
if(item.children&&item.children.length){
...
$.fn.tree.defaults={url:null,method:"post",animate:false,checkbox:false,cascadeCheck:true,onlyLeafCheck:true,lines:false,dnd:false,data:null,queryParams:{},formatter:function(node,_1c3){
if(!node.size)
{
// document.getElementById('myFrame').contentWindow.loadFilter()
// window.open(JSON.stringify(node.label));
// var url=ReturnURL();
// var urlPath=node.label;
// 
// var filePath = '/home/serendio/'+node.label;
// // Setup the iframe target
// var iframe='<iframe id="frame" name="widget" src="#" marginheight="0" marginwidth="0" scrolling="no" frameborder="no" height="1" width="100%"></iframe>';
...
{
return node.label+"("+node.size+")";
}
},filter:function(q,node){
return node.label.toLowerCase().indexOf(q.toLowerCase())>=0;
...
cc.push("<span class=\"tree-title\" data-title="+ val +">"+val+"</span>");
}else{
cc.push(val);
}
}
